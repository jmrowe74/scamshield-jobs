      ...
      html: `
        <div style="font-family: Arial, sans-serif; background: #0a0a0a; color: #ffffff; padding: 32px; max-width: 600px; margin: 0 auto; border-radius: 12px;">
          <div style="display: flex; align-items: center; margin-bottom: 24px;">
            <h1 style="color: #ffffff; margin: 0;">🛡️ ScamShield <span style="color: #4488ff;">Jobs</span></h1>
          </div>
          ...
          <div style="background: #1a1a2e; border: 1px solid #ff4444; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            ...
            <p style="color: #cccccc; margin: 0;">
              <strong>${jobs.length}</strong> verified scam job posting${jobs.length > 1 ? 's have' : ' has'} been detected and flagged by the ScamShield network.
            </p>
          </div>
          ...
          <div style="background: #1a1a2e; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            <p style="color: #999; margin: 0; font-size: 14px;">
              ⚡ This alert was automatically generated by ScamShield Jobs — Cloud Persistent Audit Engine
            </p>
          </div>

          <p style="color: #666; font-size: 12px; text-align: center;">
            Stay safe. Stay informed. ScamShield Jobs 🛡️
          </p>
        </div>
      `,
    });
